...
$request .= "WHERE dg.patientid = rg.patientid AND ";
if($category == $level){
...
elseif($category == NULL && $start_date != NULL && $end_date != NULL){
...
header('location:p_attendance_report.php');
}
}
?>
...
<th class="tablehead">PATIENTS ATTENDANCE</th>
